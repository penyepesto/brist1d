...
numeric_cols_df = df.columns
numeric_cols_dt = dt.columns
...
# Step 15: Train Final LightGBM Model
...
# Step 16: Train Additional Models (XGBoost and CatBoost)
# XGBoost
...
# Create submission file using index as ID
submission = pd.DataFrame({'id': dt.index, 'bg+1:00': predictions})
