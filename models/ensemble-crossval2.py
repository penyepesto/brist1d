...
submission_lgbm = pd.DataFrame({'id': dt['id'], 'bg+1:00': pred_lgbm})
submission_lgbm.to_csv('submission_lgbm_crossval_0.csv', index=False)

submission_xgb = pd.DataFrame({'id': dt['id'], 'bg+1:00': pred_xgb})
submission_xgb.to_csv('submission_xgb_crossval_0.csv', index=False)

submission_cat = pd.DataFrame({'id': dt['id'], 'bg+1:00': pred_cat})
submission_cat.to_csv('submission_cat_crossval_0.csv', index=False)

submission = pd.DataFrame({'id': dt['id'], 'bg+1:00': predictions})
submission.to_csv('submission_ensemble_crossval_0.csv', index=False)
