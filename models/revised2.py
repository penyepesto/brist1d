...
def create_additional_features(data):
    ...
    # Generating lag features for bg, insulin, and carbs
    # We'll create new lag features for intervals up to 6 hours, at 30-minute intervals
    max_lag_minutes = 360
    lag_step = 30
    for lag in range(lag_step, max_lag_minutes + lag_step, lag_step):
        ...
        if lag_col_suffix.isdigit():
            for feature in ['bg', 'insulin', 'carbs']:
                ...
                # Assuming the data is aggregated to 5-minute intervals, each lag represents a certain index shift
                # This may need adjusting depending on how intervals are defined
